...
module.exports = async () => {
    let allocationModel = await collection.getAllocationData();
    let deletedData = await allocationModel.deleteMany();
    let insertedData = await allocationModel.insertMany(allocateDb);
